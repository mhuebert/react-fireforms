        ...
        return (
                <div>
                    <input  onChange={this.handleChange} 
                            value={typeof this.state.nextValue}></input>
                    <a onClick={this.save}
                       className={cx({hidden: !this.hasUnsavedChanges() || this.state.savingInProgress})}>
                       Save
                    </a>
                    <div className={cx({hidden: !this.state.savingInProgress})}>
                        Saving...
                    </div>
                </div>
                );
